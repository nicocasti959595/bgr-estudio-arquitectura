...
export const miembrosFallback: Miembro[] = [
  {
    ...
    bio: "Más de diez años llevando obras adelante en CABA. Especializado en reformas integrales y dirección de obra.",
    foto: null,
    orden: 1,
  },
  {
    ...
    bio: "Arquitecto con foco en diseño y proyecto. Cada reforma parte de un concepto claro y termina con una ejecución precisa.",
    foto: null,
    orden: 2,
  },
];
