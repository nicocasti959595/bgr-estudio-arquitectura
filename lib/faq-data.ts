// Preguntas frecuentes — fuente única, usada por el componente FAQ (UI)
// y por el JSON-LD de SEO (FAQPage).

export type PreguntaFaq = { q: string; a: string };

export const preguntasFaq: PreguntaFaq[] = [
  {
